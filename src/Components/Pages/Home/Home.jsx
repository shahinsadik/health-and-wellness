  ...
  return (
    <div>
      ...
      <div className="mx-5">
        ...
        <p className=" text-[#6c63ff] text-center font-semibold mb-10">
          ...
          {data.map((singleData) => (
            <div
              ...
              <div className="px-5">
                ...
                <div data-aos="fade-up" className="flex justify-between mb-5 mt-3">
                  <p className="font-semibold text-[#6c63ff]">
                    Entry Fee: {singleData.entryFee}
                  </p>
                  <Link
      ...
      <div className="flex items-center justify-center">
        <div>
          <Link
            to="/events"
            className="text-xl btn text-center hover:bg-[#6c63ff] text-white bg-[#ff3c00] mb-10">
            See all events
          </Link>
        </div>
      </div>
      ...
      <div>
        ...
        <p className=" text-[#6c63ff] text-center mt-3 font-semibold mb-10">
          Sed ut perspiciatis unde omnis iste natus error sit <br /> voluptatem
          accusantium doloremque laudantium, totam rem aperiam
        </p>
        <div data-aos="fade-right" className="lg:my-10 my-5 lg:mx-20 md:mx-10 mx-5">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
            <div className="card bg-base-100 hover:bg-[#7459d6] shadow-2xl my-5">
              ...
              <div className="card-body items-center text-center">
                <h2 className="card-title text-2xl font-bold text-[#6243d1]">
                  Yoga
                </h2>
                <p>
            ...
            <div data-aos="fade-up" className=" card bg-base-100 hover:bg-[#7459d6] shadow-2xl my-5">
              <figure className="px-10 pt-10">
                <img
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  Fitness refers to the overall state of health and well-being
                  of an individual
                </p>
              </div>
            </div>
            <div data-aos="fade-right" className="card bg-base-100 hover:bg-[#7459d6] shadow-2xl my-5">
              <figure className="px-10 pt-10">
                <img
                  src="https://static.live.templately.com/woocommerce/2022/01/balance-icon-02.png"
                  alt="Shoes"
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  The United Nations agency working to promote health, keep the
                  world safe
                </p>
              </div>
            </div>
            <div data-aos="fade-right" className="card bg-base-100 hover:bg-[#7459d6] shadow-2xl my-5">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  We show you how to meditate properly, the benefits of regular
                  meditation practice{" "}
                </p>
              </div>
            </div>
            <div data-aos="fade-up" className="card bg-base-100 hover:bg-[#7459d6] shadow-2xl my-5">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  A spa is a location where mineral spring water is used to give
                  medicinal baths
                </p>
              </div>
            </div>
            <div data-aos="fade-right" className="card bg-base-100 hover:bg-[#7459d6] shadow-2xl my-5">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  nutrition is a regular, balanced diet.nutrition helps fuel
                  your body
                </p>
              </div>
            </div>
