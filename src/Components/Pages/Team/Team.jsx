  ...
  return (
    <div className="pt-24 mb-10 bg-[#f5f2ff]">
      ...
      <div
        ...
        data-aos-duration="2000" className=" bg-base-100 shadow-xl rounded-xl">
              <div>
                <img className="w-full" src={team.trainerImage} alt="" />
              </div>
              <div className="mx-2">
                <h1 className=" font-bold my-3 text-xl text-center text-[#6c63ff]">
                  {team.trainer}
                </h1>
                <p className=" mb-2 text-center font-semibold text-[#6c63ff]">
                  {team.category}
                </p>
